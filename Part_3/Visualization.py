...
fig_line = px.line(df_filtered, x='Year', y='Yield_kg_per_ha', color='Crop', markers=True, title="Crop Yield Trends")
fig_line.update_layout(template="plotly_dark", title_x=0.5)
st.plotly_chart(fig_line, use_container_width=True)

# ------------------ NDVI vs Yield ------------------
st.subheader("🛰️ NDVI vs Crop Yield")
fig_ndvi = px.scatter(df_filtered, x='NDVI_mean', y='Yield_kg_per_ha', color='Crop', trendline="ols", title="NDVI Trend")
